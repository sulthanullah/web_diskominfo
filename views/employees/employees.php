...
new FormBuilder( _form , {
   ...
   fields: [
      ...
      { label:'Status Instansi Induk', name:'parent_school_status', type:'select', datasource:DS.TrueFalse },
      ...
      { label:'Jenis Pegawai', name:'employment_type_id', type:'select', datasource:DS.EmploymentTypes },
      ...
      { label:'Punya Lisensi Diklat Kepemimpinan', name:'headmaster_license', type:'select', datasource:DS.TrueFalse },
      { label:'Keahlian Penunjang', name:'laboratory_skill_id', type:'select', datasource:DS.LaboratorySkills },
