...
<?php if($links->num_rows() > 0) : ?>
  <div class="bg-white space-y-3 py-3">
    <h5 class="text-title font-bold font-heading text-lg lg:text-xl px-4">Link Terkait</h5>
    <div class="px-4 divide-y">
      <a href="https://solselkab.go.id" title="solselkab.go.id" target="_blank" class="block py-2 focus:text-secondary">PEMKAB SOLSEL</a>
