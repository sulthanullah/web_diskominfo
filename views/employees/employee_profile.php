                  ...
                  <form class="form-horizontal">
                     <div class="box-body">
                        <div class="form-group">
                           <label for="assignment_letter_number" class="col-sm-4 control-label">Nomor SK</label>
                           <div class="col-sm-8">
                              <p class="form-control-static"><?=$query->assignment_letter_number?></p>
                           </div>
                        </div>
                        <div class="form-group">
                           <label for="assignment_letter_date" class="col-sm-4 control-label">Tanggal SK</label>
                           <div class="col-sm-8">
               ...
               <div class="tab-pane" id="tab_5">
                  <form class="form-horizontal">
                     <div class="box-body">
                        ...
                        <div class="form-group">
                           <label for="employment_type_id" class="col-sm-4 control-label">Jenis Kepegaiawan</label>
                           <div class="col-sm-8">
               ...
               <div class="tab-pane" id="tab_6">
                  <form class="form-horizontal">
                     <div class="box-body">
                        ...
                        <div class="form-group">
                           <label for="laboratory_skill_id" class="col-sm-4 control-label">Keahlian Penunjang</label>
                           <div class="col-sm-8">
