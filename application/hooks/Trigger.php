...
class Trigger {
    ...
    */
	...
	public function index() {
      ...
      // Short Employee Name
		$session_data['_employee'] = $school_level >= 5 ? 'Staff dan Dosen' : 'Pegawai';
      // Long Employee Name
		$session_data['__employee'] = $school_level >= 5 ? 'Staf dan Dosen' : 'Kepegawaian';
		// Subject Name
      ...
      switch ($school_level) {
		...
		switch ($school_level) {
			...
			case 7:
				...
				break;
			default:
				$session_data['_headmaster'] = 'Kepala Dinas';
				break;
		}
