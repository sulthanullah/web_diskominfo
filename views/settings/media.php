...
new FormBuilder( _form15 , {
   controller:'settings/media',
   fields: [
      { label:'Tinggi Photo Pegawai (px)', name:'setting_value', type:'number' }
   ]
});
...
new FormBuilder( _form16 , {
   controller:'settings/media',
   fields: [
      { label:'Lebar Photo Pegawai (px)', name:'setting_value', type:'number' }
   ]
});
...
new FormBuilder( _form21 , {
   controller:'settings/media',
   fields: [
      { label:'Tinggi Photo Kepala Dinas (px)', name:'setting_value', type:'number' }
   ]
});
...
new FormBuilder( _form22 , {
   controller:'settings/media',
   fields: [
      { label:'Lebar Photo Kepala Dinas (px)', name:'setting_value', type:'number' }
   ]
});
