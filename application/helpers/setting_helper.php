	...
	function general() {
		return [
			...
			[
				...
				'setting_default_value' => 'CMSku adalah Content Management System dan PPDB Online gratis untuk SD SMP/Sederajat SMA/Sederajat',
				'setting_access_group' => 'public',
	...
	function media() {
		return [
			...
			[
				...
				'setting_default_value' => 400,
				'setting_access_group' => 'public',
				'setting_description' => 'Tinggi Photo Pegawai'
			],
			[
				'setting_group' => 'media',
				...
				'setting_default_value' => 300,
				'setting_access_group' => 'public',
				'setting_description' => 'Lebar Photo Pegawai'
			],
			[
				'setting_group' => 'media',
				...
				'setting_default_value' => 400,
				'setting_access_group' => 'public',
				'setting_description' => 'Tinggi Photo Kepala Dinas'
			],
			[
				'setting_group' => 'media',
				...
				'setting_default_value' => 300,
				'setting_access_group' => 'public',
				'setting_description' => 'Lebar Photo Kepala Dinas'
			],
			[
				'setting_group' => 'media',
			...
			[
				...
				'setting_access_group' => 'public',
				'setting_description' => 'Tinggi Logo Dinas'
			],
			[
				'setting_group' => 'media',
				...
				'setting_default_value' => 120,
				'setting_access_group' => 'public',
				'setting_description' => 'Lebar Logo Dinas'
			]
		];
	}
}
	...
	function school_profile() {
		return [
			...
			[
				...
				'setting_default_value' => '',
				'setting_access_group' => 'public',
				'setting_description' => 'Kepala Instansi'
			],
			[
				'setting_group' => 'school_profile',
				...
				'setting_access_group' => 'public',
				'setting_description' => 'Photo Kepala Instansi'
			],
			[
				'setting_group' => 'school_profile',
			...
			[
				...
				'setting_default_value' => 1,
				'setting_access_group' => 'public',
				'setting_description' => 'Status Intansi'
			],
			[
				'setting_group' => 'school_profile',
