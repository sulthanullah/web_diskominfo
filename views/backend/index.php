...
<head>
	...
	<meta name="author" content="Redesign, Redesign@gmail.com">
	<meta name="designer" content="Redesign, Redesign@gmail.com">
	<meta name="reply-to" content="Redesign@gmail.com">
	<meta name="owner" content="Redesign">
	<meta name="url" content="masmarsblog.wordpress.com">
	<meta name="identifier-URL" content="masmarsblog.wordpress.com">
					...
					<ul class="nav navbar-nav">
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								<li><a href="masmarsblog.wordpress.com" target="_blank"><i class="fa fa-globe"></i> Redesign</a></li>
						...
						<div class="modal-body">
							<table class="table table-condensed table-bordered">
								<tbody>
									...
									<tr>
										<td>Author Redesign</td>
										<td>:</td>
										<td><a href="https://www.facebook.com/MasHMWibowo/">Author Redesign</a></td>
									</tr>
									<tr>
										<td>Email</td>
										<td>:</td>
									...
									<tr>
										<td>Link</td>
										<td>:</td>
										<td><a href="<?=config_item('website')?>"></a></td>
									</tr>
									<tr>
										<td>Copyright</td>
										<td>:</td>
							...
							<ol>
								<li>Tidak diperkenankan memperjualbelikan CMS ini tanpa seizin dari <a href="https://www.facebook.com/MasHMWibowo/">Pengembang Redesign CMS</a>.</li>
