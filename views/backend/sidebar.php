			...
			<?php if (in_array('blog', __session('user_privileges'))) { ?>
				<li class="treeview <?=isset($blog) ? 'active':'';?>">
					...
					<ul class="treeview-menu">
						...
						<li <?=isset($links) ? 'class="active"':'';?>><a href="<?=site_url('blog/links');?>"><i class="fa fa-sign-out"></i> Link Terkait</a></li>
						...
						<li <?=isset($opening_speech) ? 'class="active"':'';?>><a href="<?=site_url('blog/opening_speech');?>"><i class="fa fa-sign-out"></i> Selayang Pandang <?=__session('_headmaster')?></a></li>
					...
					<ul class="treeview-menu">
						...
						<li class="treeview <?=isset($employee_references) ? 'active':'';?>">
							...
							<ul class="treeview-menu">
								...
								<li <?=isset($laboratory_skills) ? 'class="active"':'';?>><a href="<?=site_url('employees/laboratory_skills');?>"><i class="fa fa-sign-out"></i> Keahlian Penunjang</a></li>
			...
			<?php if (in_array('settings', __session('user_privileges'))) { ?>
				<li class="treeview <?=isset($settings) ? 'active':'';?>">
					...
					<ul class="treeview-menu">
						...
						<li <?=isset($school_profile_settings) ? 'class="active"':'';?>><a href="<?=site_url('settings/school_profile');?>"><i class="fa fa-sign-out"></i> Profil <?=__session('school_level') >= 5 ? 'Kampus' : 'Instansi'?></a></li>
